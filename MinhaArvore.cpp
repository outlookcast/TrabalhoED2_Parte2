...
MinhaArvore::MinhaArvore()
{
    this->numRotacoes = 0;
    this->fatorDeBalanceamento = 10;
    raiz = NULL;
}
...
NoAVL* MinhaArvore::libera(NoAVL *p)
{
...
void MinhaArvore::remove(int QuestionID, int OwnerUserID, string CreationDate, int Score, string Title)
{
    raiz = auxRemove(raiz, QuestionID,OwnerUserID,CreationDate,Score,Title);
    raiz = balanciamentoInsert(raiz);
}

NoAVL* MinhaArvore::auxRemove(NoAVL* p, int QuestionID, int OwnerUserID, string CreationDate, int Score, string Title)
{
...
NoAVL* MinhaArvore::removeFolha(NoAVL *p)
{
    delete p;
    return NULL;
}

NoAVL* MinhaArvore::remove1Filho(NoAVL *p)
{
    NoAVL *aux;
    if(p->getEsq() == NULL)
        aux = p->getDir();
...
NoAVL* MinhaArvore::menorSubArvDireita(NoAVL *p)
{
...
bool MinhaArvore::auxBusca(NoAVL * p, long long unsigned c)
{
...
void MinhaArvore::insere(int QuestionID, int OwnerUserID, string CreationDate, int Score, string Title)
{
...
NoAVL* MinhaArvore::auxInsere(NoAVL *p, int QuestionID, int OwnerUserID, string CreationDate, int Score, string Title)
{
...
void MinhaArvore::imprime()
{
    imprimePorNivel(raiz, 0);
}

void MinhaArvore::imprimePorNivel(NoAVL* p, int nivel)
{
    if (p != NULL)
    {
        cout << "(" << nivel << ")";
...
NoAVL* MinhaArvore::rotacaoEsquerda(NoAVL *x)
{
    if(x != NULL)
        this->numRotacoes++;
...
NoAVL* MinhaArvore::rotacaoDireita(NoAVL *x)
{
    if(x != NULL)
        this->numRotacoes++;
...
void MinhaArvore::rotacaoD(long long unsigned x)
{
    NoAVL *anterior = NULL;
    NoAVL *aux = raiz;
...
void MinhaArvore::rotacaoE(long long unsigned x)
{
    NoAVL *anterior = NULL;
    NoAVL *aux = raiz;
...
NoAVL* MinhaArvore::balanciamentoInsert(NoAVL *x)
{
...
long long unsigned MinhaArvore::calculaChave(int QuestionID, int OwnerUserID)
{
    ///calcula chave
...
bool MinhaArvore::buscaQuestinIDUserID(int QuestionID, int UserID)
{
    return this->auxBuscaQuestinIDUserID(this->raiz,QuestionID,UserID);
}

bool MinhaArvore::auxBuscaQuestinIDUserID(NoAVL * p, int QuestionID, int UserID)
{
...
bool MinhaArvore::buscaUserID(int UserID)
{
    this->auxBuscaUserID(this->raiz,UserID);
}

bool MinhaArvore::auxBuscaUserID(NoAVL * no,int UserID)
{
    if(no != NULL)
    {
